 ...
 * @author Lemon
 */
public class ExbGoodsCancelEntList {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        ExbGoodsCancelEntList that = (ExbGoodsCancelEntList) o;

        if (id != that.id) return false;
        if (exbCancelHeadId != null ? !exbCancelHeadId.equals(that.exbCancelHeadId) : that.exbCancelHeadId != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (exbCancelHeadId != null ? exbCancelHeadId.hashCode() : 0);
